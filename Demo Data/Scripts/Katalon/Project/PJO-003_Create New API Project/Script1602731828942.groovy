...
"DATA Start PREPARATION"
	projectName = CustomKeywords.'UtilHelper.generateUniqueString'("API Project")
...
"Step#3: Create new API Project from Start Page"
...
"Step#4: Verify newly API Project is created successfully"
